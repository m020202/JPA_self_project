...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 1334829157L;
    ...
    //inherited
    public final ListPath<study.project.domain.Category, study.project.domain.QCategory> categories = _super.categories;
